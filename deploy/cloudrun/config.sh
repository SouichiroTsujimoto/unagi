...
: "${UNIGO_SUPABASE_ANON_KEY_SECRET:=unagi-supabase-anon}"
: "${UNIGO_SUPABASE_SERVICE_ROLE_KEY_SECRET:=unagi-supabase-service}"
: "${UNIGO_SUPABASE_JWT_SECRET_SECRET:=unagi-supabase-jwt}"
...
secret_map=(
  ...
  "UNIGO_SUPABASE_ANON_KEY=${UNIGO_SUPABASE_ANON_KEY_SECRET}"
  "UNIGO_SUPABASE_SERVICE_ROLE_KEY=${UNIGO_SUPABASE_SERVICE_ROLE_KEY_SECRET}"
  "UNIGO_SUPABASE_JWT_SECRET=${UNIGO_SUPABASE_JWT_SECRET_SECRET}"
